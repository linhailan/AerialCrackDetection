...
# 设置递归深度 python默认的递归深度是很有限的，大概是900多的样子
...
parser.add_option("-n", "--net", dest="net",
                  help="Network to use one of ZF or VGG16 or GoogleNet or ResNet50 or ResNet101",
                  default="ResNet50")
...
for epoch_num in range(num_epochs):
    ...
    while True:
        try:
            ...
            R = roi.rpn_to_roi(P_rpn[0], P_rpn[1], C, K.image_dim_ordering(), use_regr=True, overlap_thresh=0.7,
                               max_boxes=300)
            ...
            if C.batch_size > 1:
                ...
                try:
                    selected_neg_samples = np.random.choice(neg_samples, C.batch_size - len(selected_pos_samples),
